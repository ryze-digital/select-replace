...
| labels               | object      | <pre>{<br>&nbsp;&nbsp;selectedOptions: 'selected',<br>&nbsp;&nbsp;searchPlaceholder: 'Search options',<br>&nbsp;&nbsp;searchNoResults: 'No results found'<br>}</pre>                                                                                                                                                                                                                                                       | Texts used inside the component (override to translate or customize)        |
...
and the "no results" text can be customized via the `labels.searchPlaceholder` and `labels.searchNoResults`
options. Both single select and multiple select fields can be searched.
